...
@Component({
  selector: 'app-data-source-ioshield',
  templateUrl: './data-source-ioshield.component.html',
  styleUrls: ['./data-source-ioshield.component.scss']
})
export class DataSourceIoshieldComponent
