...
export class DataSourceComponent implements OnInit {
    ...
    updateEnabled(val: boolean) {
        ...
        this.dataSourceService.updateDataSource(this.dataSource.protocol!, { enabled: this.dataSource.enabled });
    }
    ...
    updateIpAddress(valid: boolean | null, val: string) {
        ...
        this.dataSourceService.updateDataSource(this.dataSource.protocol!, { connection: this.dataSource.connection });
    }
    ...
    onEditEnd() {
        ...
        if (this.unsavedRow!.id) {
            this.sourceDataPointService.updateDataPoint(this.dataSource!.protocol!, this.unsavedRow!);
        } else {
            this.sourceDataPointService.addDataPoint(this.dataSource!.protocol!, this.unsavedRow!);
        }
        this.clearUnsavedRow();
    }
    ...
    onDelete(obj: SourceDataPoint) {
        ...
        dialogRef.afterClosed().subscribe(dialogResult => {
            ...
            this.sourceDataPointService.deleteDataPoint(this.dataSource!.protocol!, obj);
        });
    }
