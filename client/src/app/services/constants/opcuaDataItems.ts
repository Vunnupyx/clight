export default [
  ...
  { name: 'Stack Light 2 On (Green)', address: 'ns=7;s=Light_2-SignalOn' },
  {
    name: 'Stack Light 2 Mode (Green)',
    address: 'ns=7;s=Light_2-SignalMode'
  },
  { name: 'Stack Light 3 On (Yellow)', address: 'ns=7;s=Light_3-SignalOn' },
  {
    name: 'Stack Light 3 Mode (Yellow)',
    address: 'ns=7;s=Light_3-SignalMode'
  },
  { name: 'Stack Light 4 On (Red)', address: 'ns=7;s=Light_4-SignalOn' },
  {
  ...
  { name: 'Current Run Time', address: 'ns=7;s=ActiveProgram-CurrentRunTime' },
  { name: 'Desired Parts', address: 'ns=7;s=ActiveProgram-DesiredParts' },
