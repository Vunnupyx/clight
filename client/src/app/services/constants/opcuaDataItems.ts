...
export default [
  ...
  { name: 'Name', address: 'Production.ActiveProgram.Name' },
  {
    name: 'Part Count',
  ...
  { name: 'Sensor 1', address: 'Sensor1' },
  { name: 'Sensor 2', address: 'Sensor2' },
  { name: 'Variable 1', address: 'Variable1' },
  { name: 'Variable 2', address: 'Variable2' },
  { name: 'Variable 3', address: 'Variable3' },
  { name: 'Variable 4', address: 'Variable4' }
];
