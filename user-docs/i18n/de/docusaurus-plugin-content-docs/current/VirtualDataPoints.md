...
| Verknüpfte Blinkerkennungen (Optional) | -                           | Optional können Sie andere Signale als Abhängigkeit verknüpfen. Wenn das verknüpfte Signal eine steigende Flanke hat, setzt es den Blinkerkennungsstatus dieses Signals zurück, so dass dieses Signal nur blinken kann, wenn das verknüpfte Signal auch blinkt. |
